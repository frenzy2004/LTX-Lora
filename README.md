...
python scripts/prepare_dataset.py --inventory private_work\inventory.json --output private_work\dataset
...
3. Normalize clips to 24 fps and create caption sidecars.
